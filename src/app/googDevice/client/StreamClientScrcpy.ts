    ...
    implements KeyEventListener, InteractionHandlerListener
{
    ...
    private pageLoadingOverlay?: HTMLElement;
    ...
    private showPageLoader(): void {
        ...
        androidIcon.className = 'page-android';
        ...
        loadingText.className = 'page-text';
        loadingText.textContent = 'Connecting';

        this.pageLoadingOverlay.appendChild(androidIcon);
        this.pageLoadingOverlay.appendChild(spinner);
        this.pageLoadingOverlay.appendChild(loadingText);
        document.body.appendChild(this.pageLoadingOverlay);
    }

    public hidePageLoader(): void {
        if (this.pageLoadingOverlay) {
            this.pageLoadingOverlay.classList.add('fade-out');
            setTimeout(() => {
                if (this.pageLoadingOverlay && this.pageLoadingOverlay.parentElement) {
                    this.pageLoadingOverlay.parentElement.removeChild(this.pageLoadingOverlay);
                    this.pageLoadingOverlay = undefined;
                }
            }, 300);
        }
    }
